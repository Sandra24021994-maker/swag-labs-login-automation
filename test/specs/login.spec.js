...
describe('Swag Labs - Log In Page', () => {  
    ...
    it('should log in successfully with valid credentials', async () => { 
        // Use valid credentials from loginCredentials.js
    ...
    it('should display an error message when an invalid password is provided', async () => {
        // Try to log in with a valid username and an invalid password from loginCredentials.js
    ...
    it('should display an error message when the username field is empty', async () => {
        // Try to log in without providing a username, but with a valid password from loginCredentials.js
    ...
    it('should display an error message when the password field is empty', async () => {
        // Try to log in with a valid username, but without providing a password from loginCredentials.js
    ...
    it('should display an error message when both username and password fields are empty', async () => {
        // Try to log in without providing both a username and a password from loginCredentials.js
    ...
    it('should display an error message when invalid username and valid password are provided (case-sensitive)', async () => {
        // Try to log in with an invalid username and a valid password (case-sensitive) from loginCredentials.js
    ...
    it('should display an error message when valid username and invalid password are provided (case-sensitive)', async () => {
        // Try to log in with a valid username and an invalid password (case-sensitive) from loginCredentials.js
